...
### 6. Content Changes
- If you change endgame or Polgar JSON content, redeploy the backend image.
- Do not wipe the `chess_db` Docker volume to refresh training content; that volume is only for the SQLite database.

---
**Need help?** All details are in [DEPLOY.md](/Users/pavelhumeniuk/src/chess/DEPLOY.md).
